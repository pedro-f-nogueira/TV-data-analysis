...
"""
.. module:: model_change_channel_gtb.py
    :synopsis: This module uses a gradient boosted tree with pre selected variables
...
if __name__ == '__main__':
    ...
    # Create and fit an Gradient Boosted Tree
    seed = 7
    num_trees = 400

    # Create and fit an Gradient boosted decision tree
    clf = GradientBoostingClassifier(n_estimators=num_trees, random_state=seed)
